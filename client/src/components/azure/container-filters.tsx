...
import type { AzureContainerFiltersState } from "@/hooks/use-azure-settings";
...
interface ContainerFiltersProps {
  ...
  updateFilter: <K extends keyof AzureContainerFiltersState>(
    key: K,
...
export const ContainerFilters = React.memo(function ContainerFilters({
  filters,
  updateFilter,
  resetFilters,
