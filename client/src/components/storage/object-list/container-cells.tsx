...
import { IconBrandAzure, IconCalendar } from "@tabler/icons-react";
...
export const LocationNameCell = React.memo(
  ({ name }: { name: string }) => (
    <div className="flex items-center gap-2 min-h-[2rem]">
      <IconBrandAzure className="h-4 w-4 text-blue-600 shrink-0" />
...
LocationNameCell.displayName = "LocationNameCell";
