...
export const SETTINGS_CATEGORIES = ["docker", "cloudflare", "storage", "storage-azure", "storage-google-drive", "system", "deployments", "haproxy", "tls", "github", "github-app", "agent", "self-backup", "vault", "nats", "nats-prefix-allowlist", "tailscale"] as const;
