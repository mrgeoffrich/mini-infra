...
For browser automation and browser testing tasks, use the Playwright CLI skill defined in `.Codex/skills/playwright-cli/SKILL.md`. This skill provides browser interaction capabilities including navigation, form filling, screenshots, and web testing.
...
├── Codex-guidance/       # Codex guidance files
...
These are the most commonly missed patterns. See `server/AGENTS.md` for the full service guide.
